...
////////////////////^_^ change to AVX2 implementation....
template <typename float_v>
void inline ScaleAndAdd(FVector<float> &uVector, FVector<float_v> const &vVector,
                                             float const& s) {
/*
  float_u * const __restrict__ uvals = u.values;
  float_v const * const __restrict__ vvals = v.values;
...
void inline ScaleAndAdd(FVector<float> &uVector, FVector<unsigned short> const &vVector,
                                             float const& s) {
               float  * u  = uVector.values;
